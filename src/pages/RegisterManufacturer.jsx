    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center mt-20">
      ...
      <div className="w-full max-w-lg px-8 py-10 bg-gray-800 shadow-lg rounded-lg z-10">
        ...
        <p className="text-gray-300 mb-6 text-center">
          Register your manufacturing business and contribute to a more
          transparent and efficient fertilizer supply chain.
        </p>
        ...
        <form onSubmit={handleRegister}>
          ...
          <Link to="/login" className="flex justify-center items-center mt-2">
